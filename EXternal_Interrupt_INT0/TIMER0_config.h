...
// Timer/Counter Control Register Configuration TCCR0
...
#define OCF2_STATUS    DISABLED
#define TOV2_STATUS    DISABLED
#define ICF1_STATUS    DISABLED
#define OCF1A_STATUS   DISABLED
#define OCF1B_STATUS   DISABLED
#define TOV1_STATUS    DISABLED
#define OCF0_STATUS    DISABLED
#define TOV0_STATUS    DISABLED


#define OVERFLOW_COUNTER_INITIAL 0
#define OVERFLOW_COUNTER_MAX  4



#define TCNT0_INITIAL_VALUE 224
