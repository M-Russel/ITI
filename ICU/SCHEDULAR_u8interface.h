...
#define SCHEDULAR_MAXIMUM_TASK 3
...
#define SCHEDULAR_TASKONE_PERIODICITY 1
#define SCHEDULAR_TASKONE_FIRST_DELAY 0

#define SCHEDULAR_TASKTWO_PERIODICITY 1
#define SCHEDULAR_TASKTWO_FIRST_DELAY 1


#define SCHEDULAR_TASKTHREE_PERIODICITY 1
#define SCHEDULAR_TASKTHREE_FIRST_DELAY 2
